    ...
    <div className="home">
      ...
      <div className="hero">
        ...
        <div className="hero-caption">
          ...
          <p>
            Discovering his ties to a secret ancient order,<br/> a young man living
            in modern Istanbul embarks<br/> on a quest to save the city from an<br/>
            immortal enemy.
          </p>
      ...
      <div className="more-cards">
        <TitleCards title={"Blockbuster Action & Adventure"} category={"popular"} />
